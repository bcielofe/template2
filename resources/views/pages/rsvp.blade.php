    ...
    <div class="row" style="background-color: rgba(0,0,0,0.7);">
      ...
      <div class="col-xs-10" >
        ...
        <div class="col-sm-5" style="color: white; margin-top: 50px; margin-bottom: 50px;">
          <form method="POST" action="{{url("myevents/guestlog")}}">
            {{csrf_field()}}
          <!-- style was inserted to emphasize -->
           <h3 style="font-weight: bold;"> RSVP </h3> 
            <br>
            <div class="radio">
              <label><input type="radio" name="yes">Going</label>
            </div>
            <div class="radio">
              <label><input type="radio" name="no">Not Going</label>
            </div>
            <div class="radio disabled">
              <label><input type="radio" name="maybe" disabled>Undecided</label>
            </div>    
          </form>
